  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center relative overflow-hidden animate-fade-in">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        <h1 className="text-6xl sm:text-8xl md:text-9xl font-black text-ink mb-2 opacity-10">404</h1>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
           <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-ink mb-4">Page Not Found</h2>
        </div>
