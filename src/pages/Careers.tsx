                  ...
                  <div key={position.id} className="bg-white border border-zinc-200 rounded-xl p-4 sm:p-6 hover:border-zinc-300 hover:shadow-md transition-all group">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
                      ...
                      <div className="flex gap-2">
                        <button
                          onClick={() => handleViewDetails(position)}
                          className="px-3 sm:px-4 py-2 bg-zinc-100 text-zinc-700 rounded-lg font-medium opacity-100 lg:opacity-0 lg:group-hover:opacity-100 lg:group-focus-within:opacity-100 focus-visible:opacity-100 transition-all flex items-center gap-1 sm:gap-2 text-xs sm:text-sm hover:bg-zinc-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900/30"
                        >
                        ...
                        <button
                          ...
                          className="px-4 sm:px-6 py-2 bg-zinc-900 text-white rounded-lg font-medium opacity-100 lg:opacity-0 lg:group-hover:opacity-100 lg:group-focus-within:opacity-100 focus-visible:opacity-100 transition-all flex items-center gap-1 sm:gap-2 text-sm sm:text-base w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900/30"
                        >
