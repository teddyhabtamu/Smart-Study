    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 px-4">
        <div className="max-w-md w-full bg-surface rounded-2xl shadow-sm border border-zinc-200 p-8 text-center">
          ...
          <p className="text-inksoft mb-6">Your password has been updated. Sign in with your new password.</p>
          <button
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 px-4">
        <div className="max-w-md w-full bg-surface rounded-2xl shadow-sm border border-zinc-200 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-ink mb-2">Link invalid or expired</h2>
          <p className="text-inksoft mb-6 text-sm leading-relaxed">
      ...
      <div className="flex-1 flex flex-col justify-center py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-20 xl:px-24 w-full md:w-1/2 lg:w-1/2 bg-surface relative z-10 mx-auto">
        <div className="mx-auto w-full max-w-sm md:max-w-md lg:max-w-lg xl:w-96 animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="mt-6 sm:mt-8 md:mt-10 space-y-5">
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-inksoft mb-1.5 ml-1">
                New Password
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs font-semibold text-inksoft mb-1.5 ml-1">
