...
export const CommunityPostsSkeleton: React.FC = () => (
  <div className="flex flex-col gap-4">
    {[1, 2, 3, 4].map((i) => (
      <div key={i} className="bg-surface p-4 sm:p-5 rounded-xl border border-zinc-200 shadow-sm flex gap-3 sm:gap-4 min-w-0 animate-pulse">
        <div className="flex flex-col items-center gap-1 pt-1 flex-shrink-0">
          <div className="w-5 h-5 bg-zinc-200 rounded"></div>
        </div>
        <div className="flex-1 min-w-0">
          <div className="flex items-start gap-2 mb-3">
            <div className="h-5 bg-zinc-200 rounded flex-1 min-w-0"></div>
            <div className="w-16 sm:w-24 h-6 bg-zinc-200 rounded flex-shrink-0"></div>
          </div>
