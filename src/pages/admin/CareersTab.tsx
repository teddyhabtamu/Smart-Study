            ...
            <div className="grid grid-cols-2 gap-2 sm:flex">
              ...
              {positionView === 'positions' && (
                <button
                  ...
                  className="col-span-2 sm:col-span-1 px-4 py-2 bg-zinc-900 text-onink text-sm font-medium rounded-lg hover:bg-zinc-800 transition-colors flex items-center justify-center gap-2 whitespace-nowrap"
                >
