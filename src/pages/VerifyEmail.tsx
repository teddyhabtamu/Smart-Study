    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-50 px-4">
        <div className="max-w-md w-full bg-surface rounded-2xl shadow-sm border border-zinc-200 p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-ink mb-2">Email Verified Successfully!</h2>
          <p className="text-inksoft mb-6">Your email has been verified. Welcome to SmartStudy!</p>
          <button
            onClick={() => navigate('/dashboard')}
            className="w-full py-3 px-4 rounded-xl text-sm font-medium text-onink bg-zinc-900 hover:bg-zinc-800 transition-all"
          >
    ...
    <div className="min-h-screen flex bg-surface">
      <div className="flex-1 flex flex-col justify-center py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 lg:px-20 xl:px-24 w-full md:w-1/2 lg:w-1/2 bg-surface relative z-10 mx-auto">
        <div className="mx-auto w-full max-w-sm md:max-w-md lg:max-w-lg xl:w-96 animate-fade-in">
          ...
          <div>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight text-ink mb-2">
              Verify Your Email
            </h2>
            ...
            <div className="mt-6 space-y-4">
              <div className="p-4 bg-zinc-50 border border-zinc-200 rounded-lg">
                <div className="flex items-start gap-3">
                  <Mail className="w-5 h-5 text-inksoft flex-shrink-0 mt-0.5" />
                  <div className="flex-1">
                    <p className="text-sm font-medium text-ink mb-1">Need a new verification email?</p>
              ...
              <div className="text-center">
                <button
                  ...
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-onink bg-zinc-900 hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-zinc-900 transition-all"
                >
                  Back to Login
                </button>
              </div>
