  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col gap-4 sm:gap-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-ink">Past Exams</h1>
      ...
      {filteredExams.length === 0 && !loading.documents && !errors.documents && (
        <div className="py-12 sm:py-20 text-center border border-dashed border-zinc-200 rounded-2xl bg-zinc-50/50 px-4">
          ...
          <p className="text-ink font-medium text-sm">No exam papers found</p>
    ...
    <div className="group bg-surface rounded-xl border border-zinc-200 overflow-hidden hover:border-zinc-300 hover:shadow-card transition-all flex flex-col h-full relative">
      ...
      <Link to={`/document/${exam.id}`} className="flex flex-col h-full">
        ...
        <div className="p-3 sm:p-5 flex-1 flex flex-col">
          <h3 className="font-semibold text-ink leading-snug mb-2 line-clamp-2 group-hover:text-inksoft transition-colors text-sm sm:text-base">{exam.title}</h3>
