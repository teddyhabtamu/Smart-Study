      ...
      >
        {toasts.map((toast) => (
          <div
            ...
            className="pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg bg-surface border border-zinc-200 animate-slide-up sm:min-w-[300px] sm:max-w-sm"
          >
            ...
            <button
              ...
              className="relative text-zinc-400 hover:text-inksoft transition-colors p-1 after:absolute after:-inset-2 after:content-['']"
            >
              <X size={16} />
            </button>
          </div>
